  ...
  return (
    <section className="relative py-20 md:py-32 px-6 md:px-12 max-w-7xl mx-auto text-center md:text-left overflow-hidden">
      ...
      <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900/80 border border-emerald-500/30 rounded-full mb-8 font-mono text-sm">
        ...
        <span className="text-slate-400">mediakit --version</span>
      ...
      <div className="space-y-8 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl text-slate-400 leading-relaxed max-w-3xl">
          Conecta con <span className="text-white font-semibold">{config.global.totalProfessionals}+ profesionales IT</span> que 
          buscan soluciones como la tuya.{' '}
          <span className="text-emerald-400 font-mono">Audiencia técnica real</span> y{' '}
          <span className="text-cyan-400 font-mono">contenido de calidad</span>.
        </p>
        ...
        <div className="flex flex-wrap gap-6 text-sm text-slate-400 font-mono">
          <div className="flex items-center gap-2">
            ...
            <span><span className="text-white">{config.hero.seniorLeadPercentage}</span> Senior/Lead Engineers</span>
          </div>
          <div className="flex items-center gap-2">
            <TrendingUp className="w-4 h-4 text-cyan-400" />
            <span><span className="text-white">{config.global.decisionMakersPercentage}</span> Decision Makers</span>
          </div>
        </div>
